...
class CustomTokenRefreshView(TokenRefreshView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        refresh_token_cookie = request.COOKIES.get(settings.SIMPLE_JWT.get('AUTH_COOKIE_REFRESH'))
        if refresh_token_cookie and 'refresh' not in data:
            data['refresh'] = refresh_token_cookie
...
class CustomTokenVerifyView(TokenVerifyView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if access_token and 'token' not in data:
